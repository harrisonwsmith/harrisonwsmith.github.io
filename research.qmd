...
Many of the properties that govern how a system functions are invisible to conventional sampling, or too costly to measure at the scale decisions get made. Sensors close that gap. Working across satellite, UAV, and proximal platforms, I develop methods to quantify crop and nutrient dynamics at landscape and watershed scale. In soybean, irrigation regime turns out to be written into the canopy spectrum itself, separable from reflectance alone at over 95% accuracy. What would otherwise require instrumenting a field can be read off the canopy.
